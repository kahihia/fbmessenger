...
from .views import FacebookProfileApiView, FbProfileApiView, TaskStatusView, TaskPauseView, \
...
urlpatterns = [
    ...
    url(r"^fbmessageprofile/$",
        FbMessageProfileApiView.as_view(), name="api-fb-profile"),
    ...
    url(r"^taskpause/(?P<task_id>\d+)/$", TaskPauseView.as_view(), name="api-task-pause")
]
